<?php
   ...
   // Welcome  
   $lang['strintro'] = 'Welcome to Vidyamithra';
   $lang['strppahome'] = 'Vidyamithra Homepage';
   $lang['strpgsqlhome'] = 'OSSICS Homepage';
   $lang['strpgsqlhome_url'] = 'http://www.ossics.com/';
   $lang['strlocaldocs'] = 'Vidyamithra Documentation (local)';
   $lang['strreportbug'] = 'Report a Bug';
   $lang['strviewfaq'] = 'View FAQ';
   $lang['strviewfaq_url'] = 'http://www.ossics.com/vidyamithra/?page=faq';
   ...
   // Miscellaneous
   $lang['strtopbar'] = '%s running on %s:%s -- Welcome &quot;%s&quot;, %s';
